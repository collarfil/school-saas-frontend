...
export default function Income() {
  ...
  const loadAll = async () => {
    ...
    try {
      ...
      console.log("📊 Incomes API Response:", res.data);
      
      const incomesData = extractArrayData(res);
      
      console.log("✅ Extracted incomes:", incomesData);
    ...
    <div className="text-white p-6">
      ...
      <div className="mb-4 p-3 bg-slate-800 rounded text-sm">
        <div className="text-gray-300">
          ...
          <br />
          <strong>Incomes Data Type:</strong> {typeof incomes}
          <br />
          <strong>Is Incomes Array?:</strong> {Array.isArray(incomes) ? "Yes" : "No"}
          <br />
          <strong>Incomes Count:</strong> {incomesArray.length}
        </div>
      </div>
      ...
      <div className="bg-slate-800 rounded-lg p-4 overflow-x-auto">
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-300 mb-2">No Income Records Found</h3>
            <p className="text-gray-400 mb-4">Add your first income record</p>
            <button
              onClick={handleOpenModal}
          ...
          <table className="w-full text-left">
            ...
            <tbody>
              {incomesArray.map((income, index) => (
                <tr key={income.id || index} className="border-b border-gray-700 hover:bg-slate-700/40 transition-colors">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="p-3 bg-slate-700/50 rounded text-sm">
                <p className="text-gray-300">
                  <strong>Note:</strong> This income will be recorded for your school (School ID: {getSchoolId()})
                </p>
              </div>
